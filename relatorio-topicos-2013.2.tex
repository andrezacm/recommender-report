...
\textsl{Awareness} é a consciencia ou a percepção dos membros do projeto em relação as atividades do projeto. 
\end{quote}
...
\begin{quote}\textbf{Definição do Grupo}
\textsl{Collaboration Readiness} se refere a motivação, disposição e aptidão dos membros de um grupo colaborarem entre si.
\end{quote}
...
\begin{quote}\textbf{Definição do Grupo}
O conceito de \textsl{Technology Readiness} está associada ao quanto um grupo de pessoas está preparada para adotar uma nova tecnologia para colaboração. As dificuldades associadas na adoção de uma nova tecnologia podem estar relacionadas a falta de estrutura física, falta de tempo, falta de treinamento e a falta de conhecimento do ambiente da tecnologia.
\end{quote} 
...
\begin{quote}\textbf{Definição do Grupo}
\textsl{Awareness Network} está relacionada com o compartilhamento de informações de ações realizadas pelos membros do grupo, de modo que possibilite o monitoramento das ações dos membros desse grupo. No sentido de que uma pessoa possa saber se suas atividades afetam outras pessoas e se sua atividade é afetada por outros. 
\end{quote}
...
O Facebook Messenger não contribuía para um boa \textsl{awareness}. Como já relatado, 
...
uma \textsl{awareness network}, mostrando sobre o que está sendo discutido e o que está sendo feito via email (ou lista de emails)
...
\textsl{Collaboration Readiness} em nosso sistema colaborativo. Fizemos algumas discussões, 
...
O problema do Google Drive está relacionado com a \textsl{Awareness Information}. Como a ferramenta
não notifica os seus usuários sobre mudanças no documento, não havia como saber se alguém alterou
um requisito, ou adicionou um wireframming, etc. Sentimos falta de um \textsl{broadcasting} de 
informação para que os envolvidos ficassem conscientes de mudanças.

\subsection{HipChat}
Acreditamos que o problema que encontramos com a experiência com o HipChat esteja ligado com o
conceito de \textsl{Technology Readiness}. Como já relatado, algumas pessoas não aderiram ao seu uso,
seja por falta de costume, hábito ou consciência. Houve uma certa resistência para o uso desta ferramenta 
por parte de alguns membros. Além disso, vimos nela um problema de \textsl{Awareness} que estava relacionado
apenas ao uso errado que estavamos tentando usar.


\subsection{Geral}
Acreditamos que o maior problema para o andamento do trabalho esteja de verdade na \textbf{vontade de fazer} ou, \textbf{collaboration readiness}.
Não sabemos exatamente qual a motivação de cada membro do projeto em fazê-lo e concordamos que \textbf{todos} estiveram e estão em falta nesse sentido.

Os problemas com as ferramentas e todos os outros problemas foram de pouco impacto e seriam totalmente superados, caso a \textbf{vontade de fazer}
fosse maior.

Para tentar agilizar o desenvolvimento do projeto, pretendemos fazer mais encontros semanais e tentar encontros presenciais.
...
de um software. É um fator que influi diretamente na qualidade final do produto.

Além disso, como citado anteriormente, a \textsl{collaboration readiness} não foi forte no grupo, o que talvez pudesse ser
resolvido com encontros presenciais, pois estes foram os mais produtivos sem comparação.
