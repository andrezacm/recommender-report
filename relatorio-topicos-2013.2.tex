...
\begin{quote}\textbf{Andreza Medeiros}
Commom Ground é uma característica dos participantes de um processo de colaboração (citar o distance metters). Essa característica consiste em que estes participantes tem um conhecimento em comum, ou de um mesmo contexto. Este conhecimento pode estar relacionado a cultura, conhecimento técnico ou, até mesmo, do local onde está situado. 
\end{quote}
